...
public partial class TerrainManager : Singleton<TerrainManager>
{
    ...
    {
        if (worldItem == null || worldItem.transform == null) return;
    ...
    // Overload for legacy code that passes position explicitly
    public void RemoveItem(Vector3 worldPosition, WorldObject worldItem)
    {
